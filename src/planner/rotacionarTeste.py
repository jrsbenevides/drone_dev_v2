...
class globalPlanner:
    def __init__(self):
        ...
        self.rotas = {"x": [0, -80, -90], "y": [0, 0, -90], "z": [self.alturaDrone, self.alturaDrone, -90], "yaw": [0, 2.1, -90]}
    ...
    def rotacionar(self, angle, t=7):
        ...
        if abs((angle) - (math.pi/2)) < 0.1:
            pose.pose.orientation.y = t
             ...
             pose.pose.orientation.y = t * abs(self.toGrau(angle)) / 90
